...
export class MfaPage {
    constructor(page) {
        ...
        this.emailMeButton = page.locator('#login-inner > div.login-form.loginFormArea.pad-T-xl.pad-H-md').getByText('Email me:');
        this.textMeButton = page.locator('#login-inner > div.login-form.loginFormArea.pad-T-xl.pad-H-md').getByText('Text me:');
        this.callMeButton = page.locator('#login-inner > div.login-form.loginFormArea.pad-T-xl.pad-H-md').getByText('Call me:');
    ...
    async verifyMfaPageElements() {
        ...
        await expect(this.callMeButton).toBeVisible();
    }
    ...
    async selectEmailAuthentication() {
        ...
        await expect(this.secureCodeLabel).toBeVisible();
