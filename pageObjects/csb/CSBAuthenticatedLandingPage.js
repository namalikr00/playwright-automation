...
import { PrivacyPolicyPage } from '../csb/PrivacyPolicyPage';
import { HelpSearchToolPage } from '../csb/HelpSearchToolPage';
import { OnlineBankingTermsConditionsPage } from '../csb/OnlineBankingTermsConditionsPage';
import { ACHReferenceGuidePage } from '../csb/ACHReferenceGuidePage';
import { FraudPreventionRecommendationsPage } from '../csb/FraudPreventionRecommendationsPage';
import { NoticeOfChangeLetterPage } from '../csb/NoticeOfChangeLetterPage';
import { SecurityAlertsReferenceGuidePage } from '../csb/SecurityAlertsReferenceGuidePage';
import { LockBoxPage } from '../csb/LockBoxPage';

export class CSBAuthenticatedLandingPage {
    ...
    constructor(page, context) {
        ...
        this.toolTip = page.locator('.quick-tip.quick-tip-visible.ember-view').last();
        ...
        this.internalTransfersHeader = this.page.getByRole('heading', { name: 'Internal Transfers', level: 1 });
        ...
        this.transfersMemoListItem = this.page.getByRole('textbox', { name: 'Memo' });
        ...
        this.endingCheckDateLabel = this.page.getByLabel('Ending date').first();
    ...
    async verifyAuthenticatedLandingPageElements() {
        ...
        await expect(this.page).toHaveURL('https://businessonlinebanking.bankcsb.com/communitystatebank/test/uux.aspx#/landingPage');
    }

    async verifyTransactionsMenuListItems() {
        await this.transactionsMenu.click();
        const menuItems = [
            "Internal Transfers", "Stop Payments"
        ];
    ...
    async individualTransfers(individualTransfersDetails) {
        ...
        await this.getMenuItem('Internal Transfers').waitFor({ state: 'visible' });
        await this.getMenuItem('Internal Transfers').click();
        //await fundsTransferLink.click();
        await expect(this.page).toHaveURL('https://businessonlinebanking.bankcsb.com/communitystatebank/test/uux.aspx#/transfer');
       // await expect(this.toolTip).toContainText('For Loan Payments, please click on Payments/Loan Payments.');
        await expect(this.internalTransfersHeader).toBeVisible({ timeout: 20000 });
    ...
    async singleCheckStopPayment(singleChecksDetails) {
        ...
        await expect(this.page.getByText('Complete the fields below to make a stop payment request based on known payment information.')).toBeVisible();
        ...
        await this.page.getByText('Commercial Select	XXXXXX9700').click();
    ...
    async multipleChecksStopPayment(multipleChecksDetails) {
        ...
        await expect(this.requestStopPaymentButton).toBeVisible();
        await this.accountDropdown.click();
        const firstOption = this.page.locator('role=main >> text=Commercial Select').first();
    ...
    async privacyPolicyValidation() {
        ...
        await privacyPolicyPage.verifyPageTitle("BankCSB › Privacy & Security");
        await privacyPolicyPage.verifyHeader("Privacy & Security");
        await expect(privacyPolicyPage.page).toHaveURL('https://bankcsb.com/privacy-and-security');
    }
    ...
    async remoteDepositFeature() {
        await this.servicesMenu.click();
        const [newPage] = await Promise.all([
            this.context.waitForEvent('page'),
            this.page.getByRole('link', { name: 'Remote Deposit Capture' }).click()
        ]);
        await expect(this.page).toHaveURL('https://businessonlinebanking.qcbt.com/QuadCityBankandTrustOnline/test/uux.aspx#/landingPage');
    }
    ...
    async positivePayValidation() {
        ...
        await expect(this.page).toHaveTitle("Positive Pay | Community State Bank");
    ...
    async lockboxValidation() {
        ...
        await expect(lockboxPage.page).toHaveURL('https://businessonlinebanking.qcbt.com/QuadCityBankandTrustOnline/test/mobilews/sso/vendor/10');
    }
    ...
    async onlineBankingTermsConditionsValidation() {
        ...
        await expect(onlineBankingTermsConditionsPage.page).toHaveURL('https://www.bankcsb.com/business/treasury-management/services-agreement-and-disclosure');
        await onlineBankingTermsConditionsPage.verifyPageTitle('BankCSB › Services Agreement and Disclosure');
    ...
    async achReferenceGuideValidation() {
        ...
        await expect(achReferenceGuidePage.page).toHaveURL('https://www.bankcsb.com/files/documents/ACH%20Reference%20Guide%202024%20v1024.pdf');
    }
    ...
    async fraudPreventionRecommendationsValidation() {
        ...
        await expect(fraudPreventionRecommendationsPage.page).toHaveURL('https://www.bankcsb.com/business/fraud-prevention');
        await fraudPreventionRecommendationsPage.verifyPageTitle('BankCSB › Fraud Prevention');
        await fraudPreventionRecommendationsPage.verifyHeader('Fraud Prevention');
    }
    ...
    async noticeOfChangeLetterValidation() {
        ...
        await expect(noticeOfChangeLetterPage.page).toHaveURL('https://www.bankcsb.com/business/treasury-management/noc-100925');
        await noticeOfChangeLetterPage.verifyPageTitle('BankCSB › Notice of Important Changes');
    ...
    async securityAlertsReferenceGuideValidation() {
        ...
        await expect(securityAlertsReferenceGuidePage.page).toHaveURL('https://bankcsb.com/files/documents/Security_Alerts_Reference_Guide.pdf');
        await securityAlertsReferenceGuidePage.verifyPageTitle('Microsoft Word - Security Alerts Reference Guide_Generic');
        await securityAlertsReferenceGuidePage.verifyHeader('SECURITY ALERTS REFERENCE GUIDE');
    }
    ...
    async accountPreferencesValidation() {
        ...
        await expect(this.page).toHaveTitle("Account Preferences | Community State Bank");
    ...
    async homePagePreferencesValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Home Preferences | Community State Bank");
        const pageUrl = this.page.url();
        await expect(pageUrl).toContain('https://businessonlinebanking.bankcsb.com/communitystatebank/test/uux.aspx#/settings/dashboardPreferences');
        const visibleLocators = [
    ...
    async securityPreferencesValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Security Preferences | Community State Bank");
        const pageUrl = this.page.url();
    ...
    async alertsValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Alerts | Community State Bank");
        const pageUrl = this.page.url();
        await expect(pageUrl).toContain('/settings/alerts');
        const visibleLocatorsOnSecurityPreferences = [
            this.alertsHeader.first(),
            //this.alertsToolTip,
            this.newAlertButton
        ];
        // Concurrently check visibility for all general UI elements
    ...
    async usersValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Users | Community State Bank");
        const pageUrl = this.page.url();
    ...
    async accessibilitySettingsValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Accessibility | Quad City Bank and Trust");
        const pageUrl = this.page.url();
    ...
    async userRolesValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("User Roles | Community State Bank");
        const pageUrl = this.page.url();
