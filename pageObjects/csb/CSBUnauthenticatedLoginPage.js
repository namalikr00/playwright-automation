...
export class CSBUnauthenticatedLoginPage {
    ...
    async goToUnauthenticatedLandingPage(csbCommercialurl) {
        await this.page.goto(csbCommercialurl, { timeout: 60000 });
        await this.page.waitForURL(csbCommercialurl);
    }
