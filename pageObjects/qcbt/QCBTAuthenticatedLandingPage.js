...
import { PrivacyPolicyPage } from '../cbt/PrivacyPolicyPage';
import { HelpSearchToolPage } from '../cbt/HelpSearchToolPage';
import { OnlineBankingTermsConditionsPage } from '../cbt/OnlineBankingTermsConditionsPage';
import { ACHReferenceGuidePage } from '../cbt/ACHReferenceGuidePage';
import { FraudPreventionRecommendationsPage } from '../cbt/FraudPreventionRecommendationsPage';
import { NoticeOfChangeLetterPage } from '../cbt/NoticeOfChangeLetterPage';
import { SecurityAlertsReferenceGuidePage } from '../cbt/SecurityAlertsReferenceGuidePage';
import { LockBoxPage } from '../cbt/LockBoxPage';

export class QCBTAuthenticatedLandingPage {
    ...
    async individualTransfers(individualTransfersDetails) {
        ...
        await this.getMenuItem('Funds Transfer').waitFor({ state: 'visible' });
        await this.getMenuItem('Funds Transfer').click();
        //await fundsTransferLink.click();
        await expect(this.page).toHaveURL('https://businessonlinebanking.qcbt.com/QuadCityBankandTrustOnline/test/uux.aspx#/transfer');
    ...
    async singleCheckStopPayment(singleChecksDetails) {
        ...
        await this.page.getByText('Business Money Market XXXXXX8758').click();
    ...
    async multipleChecksStopPayment(multipleChecksDetails) {
        ...
        await expect(this.requestStopPaymentButton).toBeVisible();
        await this.accountDropdown.click();
        const firstOption = this.page.locator('role=main >> text=Business Money Market').first();
    ...
    async privacyPolicyValidation() {
        ...
        await privacyPolicyPage.verifyPageTitle("Community BT › Privacy Notice");
        await privacyPolicyPage.verifyHeader("Privacy Notice");
        await expect(privacyPolicyPage.page).toHaveURL('https://communitybt.bank/privacy/privacy-notice');
    }
    ...
    async positivePayValidation() {
        ...
        await expect(this.page).toHaveTitle("Positive Pay | Quad City Bank and Trust");
    ...
    async onlineBankingTermsConditionsValidation() {
        ...
        await expect(onlineBankingTermsConditionsPage.page).toHaveURL('https://communitybt.bank/business/online-banking-and-bill-pay/business-online-banking-services-agreement-and-disclosure');
        await onlineBankingTermsConditionsPage.verifyPageTitle('Community BT › Services Agreement and Disclosure');
    ...
    async achReferenceGuideValidation() {
        ...
        await expect(achReferenceGuidePage.page).toHaveURL('https://qcbt.bank/files/documents/ACH%20Reference%20Guide%202024%20v1024.pdf');
    }
    ...
    async fraudPreventionRecommendationsValidation() {
        ...
        await expect(fraudPreventionRecommendationsPage.page).toHaveURL('https://qcbt.bank/business/treasury-management/additional-resources/fraud-prevention-recommendations');
        await fraudPreventionRecommendationsPage.verifyPageTitle('Quad City BT › Fraud Prevention Recommendations');
    ...
    async noticeOfChangeLetterValidation() {
        ...
        await expect(noticeOfChangeLetterPage.page).toHaveURL('https://qcbt.bank/business/online-banking-and-bill-pay/noc-100925');
        await noticeOfChangeLetterPage.verifyPageTitle('QCBT › Notice of Important Changes');
    ...
    async securityAlertsReferenceGuideValidation() {
        ...
        await expect(securityAlertsReferenceGuidePage.page).toHaveURL('https://qcbt.bank/files/documents/Security_Alerts_Reference_Guide.pdf');
    ...
    async accountPreferencesValidation() {
        ...
        await expect(this.page).toHaveTitle("Account Preferences | Quad City Bank and Trust");
    ...
    async homePagePreferencesValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Home Preferences | Quad City Bank and Trust");
        const pageUrl = this.page.url();
        await expect(pageUrl).toContain('https://businessonlinebanking.qcbt.com/QuadCityBankandTrustOnline/test/uux.aspx#/settings/dashboardPreferences');
        const visibleLocators = [
    ...
    async securityPreferencesValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Security Preferences | Quad City Bank and Trust");
        const pageUrl = this.page.url();
    ...
    async alertsValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Alerts | Quad City Bank and Trust");
        const pageUrl = this.page.url();
    ...
    async usersValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Users | Quad City Bank and Trust");
        const pageUrl = this.page.url();
    ...
    async userRolesValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("User Roles | Quad City Bank and Trust");
        const pageUrl = this.page.url();
