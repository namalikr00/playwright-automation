...
export class CBTAuthenticatedLandingPage {
    ...
    async verifyAuthenticatedLandingPageElements() {
        ...
        await expect(this.page).toHaveURL('https://businessonlinebanking.communitybt.com/communitybankandtrustonline/test/uux.aspx#/landingPage');
    }
    ...
    async individualTransfers(individualTransfersDetails) {
        ...
        await expect(this.page).toHaveURL('https://businessonlinebanking.communitybt.com/communitybankandtrustonline/test/uux.aspx#/transfer');
    ...
    async lockboxValidation() {
        ...
        await expect(lockboxPage.page).toHaveURL('https://businessonlinebanking.communitybt.com/communitybankandtrustonline/test/mobilews/sso/vendor/10');
    }
    ...
    async achReferenceGuideValidation() {
        ...
        await expect(achReferenceGuidePage.page).toHaveURL('https://communitybt.bank/files/documents/ACH%20Reference%20Guide%202024%20v1024.pdf');
    }
    ...
    async fraudPreventionRecommendationsValidation() {
        ...
        await expect(fraudPreventionRecommendationsPage.page).toHaveURL('https://communitybt.bank/business/treasury-management/additional-resources/fraud-prevention-recommendations');
        await fraudPreventionRecommendationsPage.verifyPageTitle('Community BT › Fraud Prevention Recommendations');
    ...
    async noticeOfChangeLetterValidation() {
        ...
        await expect(noticeOfChangeLetterPage.page).toHaveURL('https://communitybt.bank/business/online-banking-and-bill-pay/noc-100925');
        await noticeOfChangeLetterPage.verifyPageTitle('Community BT › Notice of Important Changes');
    ...
    async securityAlertsReferenceGuideValidation() {
        ...
        await expect(securityAlertsReferenceGuidePage.page).toHaveURL('https://communitybt.bank/business/treasury-management/additional-resources');
        await securityAlertsReferenceGuidePage.verifyPageTitle('Community BT › Additional Resources');
    ...
    async accountPreferencesValidation() {
        ...
        await expect(this.page).toHaveTitle("Account Preferences | Community Bank and Trust");
    ...
    async homePagePreferencesValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Home Preferences | Community Bank and Trust");
        const pageUrl = this.page.url();
        await expect(pageUrl).toContain('https://businessonlinebanking.communitybt.com/communitybankandtrustonline/test/uux.aspx#/settings/dashboardPreferences');
        const visibleLocators = [
    ...
    async securityPreferencesValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Security Preferences | Community Bank and Trust");
        const pageUrl = this.page.url();
    ...
    async alertsValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Alerts | Community Bank and Trust");
        const pageUrl = this.page.url();
    ...
    async usersValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Users | Community Bank and Trust");
        const pageUrl = this.page.url();
    ...
    async accessibilitySettingsValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("Accessibility | Community Bank and Trust");
        const pageUrl = this.page.url();
    ...
    async userRolesValidation() {
        ...
        await this.page.waitForLoadState('networkidle');
        await expect(this.page).toHaveTitle("User Roles | Community Bank and Trust");
        const pageUrl = this.page.url();
